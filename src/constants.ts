...
// export const glassEffect = "transform-gpu bg-white dark:bg-zinc-800 bg-opacity-40 backdrop-blur-md rounded drop-shadow-lg dark:bg-opacity-30 border-opacity-30 dark:border-opacity-30";
export const noGlassEffect = "bg-white dark:bg-zinc-800 rounded";
// export const glassEffect = "bg-white dark:bg-zinc-800 rounded hp:glass";
// export const glassEffect = "bg-white dark:bg-zinc-800 rounded";
